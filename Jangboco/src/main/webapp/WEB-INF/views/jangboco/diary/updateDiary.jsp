...
<link rel="stylesheet" type="text/css" href="resources/css/diary/updateDiary.css">
...
<script type="text/javascript" src="resources/script/diary/updateDiary.js"></script>
</head>
<body>
        ...
        <div class="con">
            ...
            <div class="diary_con_contnr">
            	...
            	<div class="diary_btn_contnr">
	            	<input type="button" id="update_diary_btn" class="update_diary_btn" value="수정하기">
